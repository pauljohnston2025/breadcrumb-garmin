...
function calculateDistancePointToSegment(
    ...
    if (segmentLengthSq == 0.0) {
        ...
        var xDist = pointPX - segmentAX;
        var yDist = pointPY - segmentAY;
    ...
    // Vector W = P - A
    var wx = pointPX - segmentAX;
    var wy = pointPY - segmentAY;
    ...
    // Calculate the final distance
    var xDist = pointPX - closestX;
    var yDist = pointPY - closestY;
